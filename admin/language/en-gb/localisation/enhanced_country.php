...
$_['breadcrumb_title']           	= 'Enhanced Country Manager';

// Text
$_['text_success']            		= 'Success: You have modified countries!';
$_['text_success_status']     		= 'Success: Country status saved!';
$_['text_success_country_enabled']  = 'Success: You have enabled %s Countries!';
$_['text_success_country_disabled'] = 'Success: You have disabled %s Countries!';
$_['text_list']               		= 'Country List';
$_['text_add']                		= 'Add Country';
$_['text_edit']               		= 'Edit Country';
$_['text_enable']             		= 'Enable Selected';
$_['text_disable']            		= 'Disable Selected';
$_['text_enabled2']           		= '<i class="fa fa-power-off fa-2x fa-button-on" style="color:green; cursor:pointer;"></i>';
$_['text_disabled2']          		= '<i class="fa fa-power-off fa-2x fa-button-off" style="color:red; cursor:pointer;"></i>';
$_['text_yes_icon']           		= '<i class="fa fa-check fa-2x" style="color:green; cursor:pointer;"></i>';
$_['text_no_icon']            		= '<i class="fa fa-close fa-2x" style="color:red; cursor:pointer;"></i>';
$_['text_zone_manager']            	= 'Zone Manager';
$_['text_zones']            		= 'Zones';
