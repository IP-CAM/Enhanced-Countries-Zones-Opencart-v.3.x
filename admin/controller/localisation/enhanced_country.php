...
class ControllerLocalisationEnhancedCountry extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('localisation/enhanced_country/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('localisation/enhanced_country/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['countries'][] = array(
				...
				'list_zones' => $this->url->link('localisation/enhanced_zone', 'user_token=' . $this->session->data['user_token'] . '&filter_country=' . urlencode(html_entity_decode($result['name'], ENT_QUOTES, 'UTF-8')), 'SSL'),
				'edit'       => $this->url->link('localisation/enhanced_country/edit', 'user_token=' . $this->session->data['user_token'] . '&country_id=' . $result['country_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, "SSL");
		$data['sort_iso_code_2'] = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . '&sort=iso_code_2' . $url, "SSL");
		$data['sort_iso_code_3'] = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . '&sort=iso_code_3' . $url, "SSL");
		$data['sort_status'] = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, "SSL");
		$data['sort_postcode'] = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . '&sort=postcode_required' . $url, "SSL");
		...
		$pagination->url = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
		...
		$data['zone_manager'] = $this->url->link('localisation/enhanced_zone', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');

		$this->response->setOutput($this->load->view('localisation/enhanced_country_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['country_id'])) {
			$data['action'] = $this->url->link('localisation/enhanced_country/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('localisation/enhanced_country/edit', 'user_token=' . $this->session->data['user_token'] . '&country_id=' . $this->request->get['country_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('localisation/enhanced_country', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('localisation/enhanced_country_form', $data));
	}
